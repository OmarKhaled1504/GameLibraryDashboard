...
export interface ApiGuestGuest extends Schema.CollectionType {
  ...
  attributes: {
    ...
    guest_due: Attribute.Decimal & Attribute.DefaultTo<0>;
...
export interface ApiLevelLevel extends Schema.CollectionType {
  ...
  attributes: {
    membership_level: Attribute.Integer & Attribute.Unique;
    ...
    >;
    pts_coeff: Attribute.Decimal;
    pph: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    membership_id: Attribute.Integer & Attribute.Required;
...
export interface ApiSessionSession extends Schema.CollectionType {
  ...
  attributes: {
    ...
    end_time: Attribute.DateTime;
    active: Attribute.Boolean & Attribute.DefaultTo<true>;
    total_due: Attribute.Decimal;
    duration: Attribute.String;
    member_due: Attribute.Decimal & Attribute.DefaultTo<0>;
    member_active: Attribute.Boolean & Attribute.DefaultTo<true>;
    member_st: Attribute.DateTime;
    member_et: Attribute.DateTime;
